...
const BusBookings = ({ bus, avgRating }) => {
    const { fare, reviews, name } = bus;
    ...
    const serviceFee = 10;
    // const totalAmount =
    //     Number(bus.fare) * Number(busBooking.seats) + Number(serviceFee);
        ...
        <div className="booking">
            ...
            <div className="booking__bottom">
                <ListGroup>
                    <ListGroupItem className="border-0 px-0">
                        <h5 className="d-flex align-items-center gap-1">
                            ${fare} <i class="ri-close-line"></i> 1 person
                        </h5>
                        <span> ${fare}</span>
                    </ListGroupItem>
                    <ListGroupItem className="border-0 px-0">
                ...
                <Button className="btn primary__btn w-100 mt-4" onClick={() => {
                    checkoutClickHandler(bus.fare * selectedSeats.length);
                    // bookseats();
                }}>
                    Book Now
                </Button>
